...
return new class() extends Migration
{
    public function up(): void
    {
        ...
        Schema::create('re_properties', function (Blueprint $table) {
            ...
            $table->string('property_license_number');
            $table->date('property_license_date');
        ...
        Schema::create('re_account_types', function (Blueprint $table) {
            $table->id();
            $table->string('name');
            $table->timestamps();
        });
        ...
        Schema::create('re_seekers', function (Blueprint $table) {
            $table->id();
            $table->timestamps();
            $table->foreignId('account_id')
                ->references('id')
        ...
        Schema::create('re_agent_properties', function (Blueprint $table) {
            $table->id();
            $table->timestamps();
