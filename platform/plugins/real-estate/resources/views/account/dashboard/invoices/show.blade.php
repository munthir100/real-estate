        ...
        <div class="card">
                    ...
                    <div class="mb-5">
                        <div class="row align-items-center">
                            <div class="col-md-9 row">
                                ...
                                <div class="col-lg-3">
                                    <strong
                                        class="text-brand">{{ trans('plugins/real-estate::invoice.purchase_at') }}:</strong>
                                    {{ $invoice->created_at->translatedFormat('j F, Y') }}
                                </div>
                                <div class="col-lg-3">
                                    <strong
                                        class="text-brand">{{ trans('plugins/real-estate::invoice.payment_method') }}:</strong>
                        ...
                        <tfoot>
                            <tr>
                                <th
                                    class="text-end"
                                    colspan="2"
                                >{{ trans('plugins/real-estate::invoice.sub_total') }}:</th>
                            ...
                            @if ($invoice->tax_amount > 0)
                                <tr>
                                    <th
                                        class="text-end"
                                        colspan="2"
                                    >{{ trans('plugins/real-estate::invoice.detail.tax_amount') }}:</th>
                            ...
                            @if ($invoice->discount_amount > 0)
                                <tr>
                                    <th
                                        class="text-end"
                                        colspan="2"
                                    >{{ trans('plugins/real-estate::invoice.discount_amount') }}:</th>
            ...
            <div class="card-footer text-center">
                <a
                    ...
                    href="{{ route('public.account.invoices.generate', ['id' => $invoice->id, 'type' => 'print']) }}"
                    target="_blank"
                >
                ...
                <a
                    ...
                    href="{{ route('public.account.invoices.generate', ['id' => $invoice->id, 'type' => 'download']) }}"
                    target="_blank"
                >
