    ...
    @if ($isDefaultLanguage)
        <div class="d-flex justify-content-between">
            <button
                ...
                type="button"
            >{{ trans('plugins/real-estate::custom-fields.add_a_new_custom_field') }}</button>
        </div>
    @endif
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div>
                        <label
                            for="custom-field-id">{{ trans('plugins/real-estate::custom-fields.modal.select_field') }}</label>
                        <div class="ui-select-wrapper">
                            ...
                            >
                                <option value="">
                                    {{ trans('plugins/real-estate::custom-fields.add_a_new_custom_field') }}</option>
                ...
                <div class="modal-footer">
                    ...
                    <button
                        ...
                        id="add-new"
                        type="button"
                    >{{ trans('plugins/real-estate::custom-fields.modal.button') }}</button>
                </div>
            </div>
        </div>
    </div>
