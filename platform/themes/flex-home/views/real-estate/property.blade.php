    ...
    <div class="container-fluid w90 padtop20">
        ...
        <div class="row">
            <div class="col-md-8">
                    ...
                    <div class="col-sm-12">
                        <div class="row item">
                            ...
                            <div class="col-md-8 col-sm-7 pt-2 pr-sm-0 bg-light">
                                <h5><a class="font-weight-bold text-dark" href="{{ $project->url }}">{!! BaseHelper::clean($project->name) !!}</a></h5>
                ...
                <div class="d-none d-print-block">
                    <a class="text-decoration-none" href="https://www.google.com/maps/search/{{ urlencode($property->location) }}">
                        {{ $property->location ?: $address }}
                    </a>
                </div>
                @endif
                    ...
                    <div class="row rowm10 itemagent">
                        <div class="col-lg-4 colm10">
                            ...
                            <a href="{{ $account->url }}">
                                ...
                                <img class="img-thumbnail" src="{{ RvMedia::getImageUrl($account->avatar->url, 'thumb') }}" alt="{{ $account->name }}">
                                @else
                                <img class="img-thumbnail" src="{{ $account->avatar_url }}" alt="{{ $account->name }}">
                                @endif
                            </a>
                            @else
                            @if ($account->avatar->url)
                        ...
                        <div class="col-lg-8 colm10">
                            <div class="info">
                                ...
                                @endphp
                                <p class="mobile" dir="ltr"><a href="tel:{{ $account->phone }}">{{ $account->phone }}</a></p>
                                @else
                                <p class="mobile" dir="ltr"><a href="tel:{{ theme_option('hotline') }}">{{ theme_option('hotline') }}</a>
                                </p>
                                @endif
                                ...
                                @endif
                                @if ($account->url)
                                <p><span class="fas fa-arrow-circle-right me-1"></span> <a href="{{ $account->url }}">{{ __('More properties by this agent') }}</a></p>
                                @endif
                            </div>
                        </div>
                    </div>
